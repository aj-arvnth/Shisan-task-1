...
function OthersLogin() {
  ...
  const handleSignIn = (e) => {
    ...
    if (formData.email.length > 0 && formData.email !== "Others@gmail.com") {
    ...
    if (Object.keys(errors).length === 0) {
      if (
        formData.email === "others@gmail.com" &&
        formData.password === "pass"
      ) {
        navigate("/others-landing");
      }
    }
  ...
  return (
    <>
      ...
      <Components.Container signinIn={signIn}>
        ...
        <Components.Form>
          <Components.Title>Others Login</Components.Title>
          <TextField
            required
            style={{ width: 400 }}
            type="email"
