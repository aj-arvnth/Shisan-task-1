...
function BrokerLogin() {
  ...
  const handleSignIn = (e) => {
    ...
    if (formData.email.length > 0 && formData.email !== "broker@gmail.com") {
    ...
    if (Object.keys(errors).length === 0) {
      if (
        formData.email === "broker@gmail.com" &&
        formData.password === "pass"
      ) {
        navigate("/broker_landing");
      }
    }
  ...
  return (
    <Components.Container>
      <Components.SignInContainer signinIn={signIn}>
        <Components.Form>
          <Components.Title>Broker Login</Components.Title>
          <Components.Input
            type="email"
            name="email"
            placeholder="Email : broker@gmail.com"
      ...
      <Components.OverlayContainer signinIn={signIn}>
        <Components.Overlay signinIn={signIn}>
          <Components.RightOverlayPanel signinIn={signIn}>
            <Components.Title>Welcome broker !</Components.Title>
